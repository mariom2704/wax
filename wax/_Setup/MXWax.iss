...
VersionInfoProductVersion=4.4.0
...
Source: ..\..\..\wax\_Setup\2008vcredist_x86.exe; DestDir: {app}; Permissions: users-readexec; Flags: deleteafterinstall
Source: ..\..\..\wax\_Setup\2008vcredist_x86sp1.exe; DestDir: {app}; Permissions: users-readexec; Flags: deleteafterinstall
Source: ..\..\..\wax\_Setup\2008vcredist_x86sp11.6161.exe; DestDir: {app}; Permissions: users-readexec; Flags: deleteafterinstall
...
[Run]
Filename: {app}\2008vcredist_x86.exe; Parameters: /qb
Filename: {app}\2008vcredist_x86sp1.exe;  Parameters:
Filename: {app}\2008vcredist_x86sp11.6161.exe;  Parameters:
