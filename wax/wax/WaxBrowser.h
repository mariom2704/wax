// CWebBrowser2.h: Deklaration der mit Microsoft Visual C++ für das ActiveX-Steuerelement erstellten Wrapperklassen
...
class CWaxBrowser : public CWnd
{
protected:
	DECLARE_DYNCREATE(CWaxBrowser)
public:
