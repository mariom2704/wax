SELECT sum(w.Anzahl) as GesPositionen,
       ...
       w.pspelement, w.sdauftragsnr, w.auftragsbez, w.bauabschnitt, w.sachbearbeiternl, w.nl, n.Bezeichnung
...
and w.nl != 284
group by w.sdauftragsnr
order by n.region, w.nl, w.sdauftragsnr