SELECT st.wanr, s.eleid as ElementId,s.Artikelnr,vk.Deutsch as Bezeichnung,s.DN,s.AnschlussDN,sum(s.anzahllaenge)as Menge,sap.me as Einheit, sum(s.anzahllaenge * s.preis) as Preis
