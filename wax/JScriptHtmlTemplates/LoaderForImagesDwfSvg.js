    ...
    for( i=0; i < m_ArrayOfAllImagePath.length; i++)
    {
        ...
        { 
           ...
           if(m_CurrentHeader.indexOf("HeaderTable-1") == -1)
           {
                ...
                imgContainer.style.alignItems = "center"; // Vertikale Ausrichtung in der Mitte (optional)
                imgContainer.style.justifyContent = "center"; // Zentriert die Bilder horizontal
                imgContainer.style.margin = "0 auto"; // Zentriert den Container selbst in der Zelle
                ...
                // Erstellen des figcaption-Elements für die Beschriftung
                var caption = document.createElement("figcaption");
                caption.textContent = "Anzahl:  " + strTemp[1];
                
                // Fügen Sie das img-Element und das figcaption-Element zum figure-Element hinzu
                figure.appendChild(img);
                figure.appendChild(caption);
                
                imgContainer.appendChild(figure);

                if(strJpgImagePath[2] != undefined)
                {
                    var figureFm1 = document.createElement("figure");
                    var imgFMstart = document.createElement("img");
                    imgFMstart.align = "center";
                    imgFMstart.src = strJpgImagePath[2];
                  
                    imgFMstart.height = "40";
                    imgFMstart.width = "150";
                    imgFMstart.style.marginLeft = "30px";
                    
                    var captionFm1 = document.createElement("figcaption");
                    captionFm1.textContent = "FM 1 ";
                    
                    figureFm1.appendChild(imgFMstart);
                    figureFm1.appendChild(captionFm1);
                    
                    imgContainer.appendChild(figureFm1);
                } 
                
                if(strJpgImagePath[3] != undefined)
                {
                    var figureFm2 = document.createElement("figure");
                    var imgFMEnd = document.createElement("img");
                    imgFMEnd.align = "center";
                    imgFMEnd.src = strJpgImagePath[3];
                  
                    imgFMEnd.height = "40";
                    imgFMEnd.width = "150";
                    imgFMEnd.style.marginLeft = "30px";
                    
                    var captionFm2 = document.createElement("figcaption");
                    captionFm2.textContent = "FM 2 ";
                    
                    figureFm2.appendChild(imgFMEnd);
                    figureFm2.appendChild(captionFm2);
                    
                    imgContainer.appendChild(figureFm2);
                }
