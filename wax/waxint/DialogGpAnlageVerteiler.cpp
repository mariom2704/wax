...
DialogGpAnlageVerteiler::DialogGpAnlageVerteiler(MxCObList *auftraege)
	: GpAnlageSaegeNut(auftraege)
{
	fieldDummy = ".";
}

DialogGpAnlageVerteiler::~DialogGpAnlageVerteiler()
{
}



bool DialogGpAnlageVerteiler::createVerteilerXls(bool bDir_verteiler_free)
{
	//Werte erzeugen
	if (!createWerte())
		return false;
...
Exceldatei erzeugen
*/
bool DialogGpAnlageVerteiler::createExcelDatei()
{
	Werkauftrag *werkauftrag = getFirstAuftrag();
	if (!werkauftrag)
		return false;
...
*/
bool DialogGpAnlageVerteiler::writeLeitkarte()
{		
...
*/
bool DialogGpAnlageVerteiler::writeVerteilerdaten()
{
	//Tab erzeugen
...
bool DialogGpAnlageVerteiler::writeRohrdaten()
{
	//Tab anlegen
...
bool DialogGpAnlageVerteiler::writeDummyZeile(int anzahl, ExcelODBC &excel, const MxString &datei, const MxString &table, char* values[], int anzValue)
{
	//Dummywerte setzen
...
bool DialogGpAnlageVerteiler::createTab(ExcelODBC &excel, const MxString &datei, const MxString &table, char* columns[], int type [], int anzahlSpalten)
{
...
bool DialogGpAnlageVerteiler::writeRow(ExcelODBC &excel, const MxString &datei, const MxString &table, char* values[])
{
