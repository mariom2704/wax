...
void SimpleBrowser::Print(SimpleBrowser::PRINT print, LPCTSTR header,LPCTSTR footer)
{
	if (_Browser != NULL) {
		...
		switch (print)
		{
		case SimpleBrowser::PRINT_NO_PROMPT:
			hr = _Browser->ExecWB(OLECMDID_PRINT, OLECMDEXECOPT_DONTPROMPTUSER,&parameter,NULL);
			break;
		case SimpleBrowser::PRINTPREVIEW:
			hr = _Browser->ExecWB(OLECMDID_PRINTPREVIEW, OLECMDEXECOPT_PROMPTUSER,&parameter,NULL);
			break;
		case SimpleBrowser::CHOOSEPRINTER:
		default:
			hr = _Browser->ExecWB(OLECMDID_PRINT, OLECMDEXECOPT_PROMPTUSER,&parameter,NULL);
			break;
		}
                                       ...
                                       VARIANT_BOOL *Cancel)
{
	...
	UNREFERENCED_PARAMETER(Flags);	// Note: flags value is reserved
