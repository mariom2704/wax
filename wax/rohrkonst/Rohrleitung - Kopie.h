...
public:
	void set_SprinklerschellenGewaehlt(bool lbSprinklerschellen)
	{
		bSprinklerschellen = lbSprinklerschellen;
	};

	bool get_SprinklerschellenGewaehlt()
	{
		return bSprinklerschellen;
	};
	...
	/// Achtung: UpToDate halten!
	virtual void copy(const Rohrleitung& other);
