...
/// @endcond 
{
    ...
    TECIT_HS("EPS")                                 eIMEps          ,       ///< =8: EPS-Vector-Image (not supported in ConvertToStream and ConvertToStreamEx)
...
///  Enumeration Values for TBarCode for <b>Windows</b>:<ul><li>eLicProd1D = 2002: (1D codes)<li>eLicProd2D = 2003: (2D codes)</ul><br>
///  Enumeration Values for TBarCode for <b>Windows x64</b>:<ul><li>eLicProd1D = 2004: (1D codes)<li>eLicProd2D = 2005: (2D codes)</ul><br>
///  Enumeration Values for TBarCode for <b>Office</b>:<ul><li>eLicProd1D = 2000: (1D codes)<li>eLicProd2D = 2001: (2D codes)</ul><br>
///  Enumeration Values for TBarCode for <b>Windows CE</b>:<ul><li>eLicProd1D = 46: (1D codes)<li>eLicProd2D = 47: (2D codes)</ul><br>
///  Enumeration Values for TBarCode for <b>Unix</b>:<ul><li>eLicProd1D = 2006: (1D codes)<li>eLicProd2D = 2007: (2D codes)</ul><br>
//----------------------------------------------------------------------------
#ifdef TEC_UNIX
  typedef enum 
  /// @cond INCLUDE_IN_DOXY
  ...
  /// @endcond 
  {
    ...
    TECIT_HS("TBarCode 1D (standard)")              eLicProd1D = 2006,     ///< : Generates linear barcodes only (values see above)
    TECIT_HS("TBarCode 2D (1D + 2D symbologies)")   eLicProd2D = 2007,     ///< : Generates linear AND 2D codes (values see above)
  }
  e_licProduct;
  ...
  {
    TECIT_HS("Invalid product ID")                        eLicInvalid = -1,      ///< =-1: No valid product-id
    TECIT_HS("TBarCode Office 1D (standard)")             eLicOffice1D = 2000,   ///< : Generates linear barcodes for TBarCode Office only (values see above)
    TECIT_HS("TBarCode Office 2D (1D + 2D symbologies)")  eLicOffice2D = 2001,   ///< : Generates linear AND 2D codes for TBarCode Office  (values see above)
    TECIT_HS("TBarCode 1D (standard)")                    eLicProd1D = 2004,     ///< : Generates linear barcodes only (values see above)
    TECIT_HS("TBarCode 2D (1D + 2D symbologies)")         eLicProd2D = 2005,     ///< : Generates linear AND 2D codes (values see above)
  }
  e_licProduct;
...
e_licProduct;
  ...
  /// @endcond 
  {
    ...
    TECIT_HS("TBarCode Office 1D (standard)")             eLicOffice1D = 2000,   ///< : Generates linear barcodes for TBarCode Office only (values see above)
    TECIT_HS("TBarCode Office 2D (1D + 2D symbologies)")  eLicOffice2D = 2001,   ///< : Generates linear AND 2D codes for TBarCode Office  (values see above)
    TECIT_HS("TBarCode 1D (standard)")                    eLicProd1D = 2002,     ///< : Generates linear barcodes only (values see above)
    TECIT_HS("TBarCode 2D (1D + 2D symbologies)")         eLicProd2D = 2003,     ///< : Generates linear AND 2D codes (values see above)
  }
  e_licProduct;
#endif
...
/// @endcond 
{
    ...
    eErr_QuietZoneTooSmall        = 0x800719E2L,                    ///<    Quiet zone to small for vertical bearer bars
...
/// @endcond 
{
  ...
  /// If module width is set (DLL: function BCSetModWidth(); OCX: property TBarCode10Lib::ITBarCodeBase::ModuleWidth), then #eSizeMode_CustomModuleWidth is used; otherwise #eSizeMode_FitToBoundingRect.\n
  ...
  /// BCSetModWidth() and BCSetModWidthN() (DLL) or TBarCode10Lib::ITBarCodeBase::ModuleWidth (OCX).\n
  ...
  /// The output/scanning resolution has to be set with BCSetDPI() (DLL) or TBarCode10Lib::ITBarCodeBase::Dpi (OCX). 
  /// The type of barcode decoder has to be set with BCSetDecoder() (DLL) or TBarCode10Lib::ITBarCodeBase::Decoder (OCX).\n
...
/// @endcond 
{
  ...
  /// (See also DLL: function BCGet/BCSetCodePage, OCX: property TBarCode10Lib::ITBarCode::CodePage).\n
...
/// (See also DLL: function BCGet/BCSetEncodingMode, OCX: property TBarCode10Lib::ITBarCode::EncodingMode).
