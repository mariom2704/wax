...
void HtmlDruck::insertOberflaeche(Werkauftrag* xWerk, const Beschichtung &beschichtung, BOOL zeugnis, BOOL sichtbereich, int iKolliliste)
{
    /*
	...
	*/
	...
	if(xWerk != NULL && xWerk->get_GUID().IsEmpty() == FALSE)
	{
		oberfl = "";
	}
