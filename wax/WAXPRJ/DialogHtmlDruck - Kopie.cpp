...
void DialogHtmlDruck::insertOberflaeche(const Beschichtung &beschichtung, BOOL zeugnis, BOOL sichtbereich, int iKolliliste)
{
    /*
...
void DialogHtmlDruck::insertLeitkarte(Leitkarte& leitkarte, Status& status, const CString& name, const CString & ziel, bool umbruch)
{
		/*
	...
	*/
	...
	"\n<center>\n<table border=\"1\" cellspacing=\"0\" cellpadding=\"3\" width=\"100%\">\n"
		...
		"<tr>"
			...
			// 3. spalte
			"<td width=\"20%\" valign=\"middle\" colspan=\"1\">\n<font face=\"arial\" size=\"4\"><p align=\"center\"><div id=\"ele3\" align=\"center\">" 
				+ ziel							// z.b. versand
				+ "</div></p></font></td></tr>\n";
	/*
		head +=	
...
void DialogHtmlDruck::insertLaengeGewichtBarcode(int maxlaenge, double gewicht, CString kc, int kcPosnr, string ids )
{
	/*
