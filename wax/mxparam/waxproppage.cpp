...
{
	/**
	Standardeinstellungen wiederherstellen über set_default
	*/
...
{
	/**
	Disabled ein Dialogelement, wenn der Parameter nicht für den User freigegeben
...
{
	/**
	Ruft für jeden Stringparameter in strpara und paralst die Methode enable_item auf
	*/
	map<UINT, int>::iterator it;
	for (it = strpara.begin(); it != strpara.end(); it++)
	{
