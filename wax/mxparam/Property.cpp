...
{
	/**
	Führt eine Passwortabfrage aus. Das Passwort muss nur einmal richtig eingegeben werden.
	Liefert true zurück, wenn Passwortdialog mit Ok bestätigt wurde, unabhängig von der Richtigkeit
	der Eingabe. Wenn das Passwort falsch oder gar nicht eingegeben wurde, können nur die persönlichen
...
{
	/**
	Setzt die Eingabefelder der aktiven Einstellungsseite auf die Defaultwerte zurück
	*/
