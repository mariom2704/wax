...
public:
	...
	/// Prüft, ob der Userlogin noch nicht in der Benutzertabelle eingetragen ist
	bool is_new_user(const std::string& login);

	/// Benutzer hinzufügen, Systemparameter erzeugen
...
private:
	...
	/// Name des Users, dessen Systemparameter geladen werden sollen. Ist nur für 
	...
	// Nur damit das Programm im Fehlerfall nicht abstürzt
...
inline MXDatabase* MxParameter::get_db()
{
	return db;
}
